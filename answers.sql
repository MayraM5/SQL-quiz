...
SELECT * FROM salespeople WHERE region LIKE 'Northwest';
...
SELECT email FROM salespeople WHERE region LIKE 'Southwest';
...
SELECT first_name, last_name, email FROM salespeople WHERE region LIKE 'Northwest';
...
SELECT email FROM salespeople WHERE region LIKE 'Northwest' OR region LIKE 'Southwest';
